...
public class ChildFragmentLeftPagerAdapter extends FragmentPagerAdapter 
{
	List<ChildFragment> fragments = new ArrayList<ChildFragment>();

	public ChildFragmentLeftPagerAdapter(FragmentManager fm) 
	{
		super(fm);
	...
	{
		fragments.add(new ChildFragment(Color.BLUE,		"0"));
